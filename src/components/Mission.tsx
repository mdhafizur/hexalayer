    ...
    return (
        <Box
            sx={{
                ...
                px: { xs: 2, md: 4 },
                backgroundColor: theme => theme.palette.mode === 'dark' ? "#1976d2" : "#bbdefb", // Blue shades
                display: "flex",
                ...
                >
                    ...
                    >
                        <FaCogs
                            ...
                            color="#ffd700"
                            aria-label="Cogs icon representing mission"
                            style={{
                    ...
                    >
                        Building layered AI-driven solutions that integrate data and security  for seamless management.
                    </Typography>
                </motion.div>
            </Box>
        </Box>
